...
namespace Elision.Rules.GetRenderingDatasource
{
    public class AddWebsiteDatasourceRootAction<T> : AddDatasourceRootAction<T> where T : GetRenderingDatasourceRuleContext
    {
        public override void Apply(T ruleContext)
        {
            ...
            var websiteFolder = contextItem.Axes.SelectSingleItem("ancestor-or-self::*[@@TemplateID='" + TemplateIDs.WebsiteFolder + "']");
            ...
            BuildNewDatasourceRoot(folderPath, folderTemplate, websiteFolder, "Website Shared {0}s", dsTemplate);
