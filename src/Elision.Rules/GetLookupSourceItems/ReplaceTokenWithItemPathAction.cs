...
namespace Elision.Rules.GetLookupSourceItems
{
    public class ReplaceTokenWithItemPathAction<T> : RuleAction<T> where T : GetLookupsourceItemsRuleContext
    {
        ...
        public override void Apply(T ruleContext)
        {
            ...
            ruleContext.Args.Source =
                ruleContext.Args.Source.Replace(
                    string.Concat(ruleContext.Settings.QueryTokenPrefix, Token, ruleContext.Settings.QueryTokenSuffix),
                    newItem.Paths.FullPath);
        }
    }
}
